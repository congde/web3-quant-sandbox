...
| Public learning academy | `/academy`, `/math-learning`, `/backtest-learning`, `/kline-learning`, `/risk-learning` | `src/web/src/pages/learning/` | Quantitative math, backtesting, K-line, diagnostic analysis, asset-management, and risk-control courses with 169 formulas, 43 chapter guides, search, progress, exercises, pitfalls, sources, and clickable formula dossiers covering origin, derivation, intuition, evolution, and related formulas |
